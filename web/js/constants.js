...
const TRIBULATION_INTENT_POOLS = {
  suiguang: [
    { type: "attack", w: 50, ratio: [0.16, 0.22], label: "金光扫落", short: "金光", element: "weapon", wuxing: "metal" },
    { type: "block", w: 20, ratio: 0.08, label: "榜文凝聚", short: "凝聚", element: "soul", wuxing: "earth" },
    { type: "curse_weak", w: 30, label: "照影摄魂", short: "摄魂", element: "soul", wuxing: "water" },
  ],
  jinying: [
    { type: "attack", w: 45, ratio: [0.2, 0.26], label: "金鞭抽魂", short: "金鞭", element: "weapon", wuxing: "metal" },
    { type: "charge", w: 20, label: "真灵牵引，雷霆将落", short: "牵引", wuxing: "wood" },
    { type: "curse_burn", w: 20, ratio: 0.03, label: "劫火焚身", short: "劫火", element: "fire", wuxing: "fire" },
    { type: "block", w: 15, ratio: 0.1, label: "榜文护持", short: "护持", element: "soul", wuxing: "earth" },
  ],
  yipie: [
    { type: "attack", w: 45, ratio: [0.22, 0.3], label: "封神一瞥", short: "一瞥", element: "calamity", wuxing: "metal" },
    { type: "charge", w: 20, label: "真灵牵引，雷霆将落", short: "牵引", wuxing: "wood" },
